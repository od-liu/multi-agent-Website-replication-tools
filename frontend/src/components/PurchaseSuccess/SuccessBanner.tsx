...
const SuccessBanner: React.FC<SuccessBannerProps> = ({ orderNumber, passengers }) => {
  ...
  return (
    <div className="success-banner">
      <div className="success-pay-tips">
        <img
        ...
        <div className="success-greet">
          <strong className="success-strong">交易已成功！</strong>
          感谢您选择铁路出行！您的订单号：
          <span className="order-number">{orderNumber}</span>
        </div>

        <p className="success-desc success-desc-normal">
          {formatPassengerInfo()}可持购票时所使用的中国居民身份证原件于购票后、列车开车前到车站直接检票乘车。
        </p>
        <p className="success-desc success-desc-bold">
